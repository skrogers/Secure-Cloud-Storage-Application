...
eel.expose(privMenu)
function privMenu() {
    document.getElementById("statusText").innerHTML = "Menu";   //changing inner text
    ...
    button1.style.display = 'inline-block';         //loads over the samepage over it
...
function uploadScreen() {
    var button1 = document.getElementById('upload');
    var button2 = document.getElementById('download');      //called to make display
    var button3 = document.getElementById('settings');
    var button4 = document.getElementById('logout');
    button1.style.display = 'none';
    ...
    button5.style.display = 'inline-block';     //to show on same page
...
function downloadScreen() {
    ...
    var button4 = document.getElementById('logout');
    button1.style.display = 'none';
    button2.style.display = 'none';             //to hide them, display 0
    button3.style.display = 'none';
    button4.style.display = 'none';
    
    var searchText = document.getElementById('searchQuery');        //docu - index.html. Stores all value in var. Class type variable as all types of values are stored here
    var searchButton = document.getElementById('searchButton');         // like c++ class
    var downloadButton = document.getElementById('downloadButton');
    var button6 = document.getElementById('backButton');
...
function logOut() {
    ...
    document.getElementById("statusText").innerHTML = "Secure Cloud Storage Application";
